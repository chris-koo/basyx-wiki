...
Creation and update timestamp filters support synchronization workflows that only need descriptors changed after a given time. Filter syntax, allowed values, and combination rules are part of the API contract and are documented in Swagger.
